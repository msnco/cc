...
//	console.log(arr+" :: "+arr0);
	...
	for(var i=indexVal; i<valTwo; i++){
		if(i == ranNum){
			creatImg += '<ins class="adsbygoogle" style="display:block;margin-top:10px;" data-ad-format="fluid" data-ad-layout-key="-d0-8q+1h+e7+kh" data-ad-client="ca-pub-1937515231401291" data-ad-slot="7813549177"></ins>';
		}
